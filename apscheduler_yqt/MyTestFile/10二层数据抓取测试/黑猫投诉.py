...
from utils.secodnd_data_utils import crawl_second_by_webdriver
...
if __name__ == '__main__':
  request=db_qbbb.execute_query("select SN,URL from TS_DataMerge_Base where URL like '%tousu.sina.com.cn%' and PublishDate_Std>'2021-08-01 17:37:23'")
  for item in request:

      content='<pre style="white-space: pre-wrap;white-space: -moz-pre-wrap;white-space: -pre-wrap;white-space: -o-pre-wrap; word-wrap: break-word;"><zhengwen>'+crawl_second_by_webdriver(item[1])+'</zhengwen></pre>'
      update_sql=f"update TS_DataMerge_Base set Body='{content}' where SN='{item[0]}'"
